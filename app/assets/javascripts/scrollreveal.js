...
sr.reveal('.nom', { origin:"bottom", distance: '50px', duration: 1000, reset:false });
sr.reveal('.base-line', { origin:"bottom", distance: '50px', duration: 1000, delay: 500, reset:false });
sr.reveal('.slogan', { origin:"bottom", distance: '50px', duration: 1000, delay: 1000, reset:false });
sr.reveal('.bouton0', { origin:"bottom", distance: '50px', duration: 1000, delay: 1000, reset:false });
sr.reveal('.bouton1', { origin:"bottom", distance: '50px', duration: 1000, delay: 1500, reset:false });
sr.reveal('.bouton2', { origin:"bottom", distance: '50px', duration: 1000, delay: 2000, reset:false });
sr.reveal('.bandeau-banner', { origin:"left", distance: '50px', duration: 1000, delay: 2000, reset:false });
...
sr.reveal('.container-contact100-form-btn', { origin:"bottom", distance: '50px', duration: 500, delay: 500, reset:false });
